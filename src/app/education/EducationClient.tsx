...
const EDU_HUANG_TOPICS = [
  ...
  },
  {
    ...
    sections: [
      {
        title: '孩子的正常專注時間',
        content: '孩子「坐不住」有時候只是因為要求太高了！\n\n正常的專注時間：年齡 × 2~5 分鐘 = 合理專注時長\n例如：4歲的孩子專注8-20分鐘是正常的\n\n💡 專注力是一個光譜，不是有沒有，而是多少。',
      },
      {
        title: '大腦運作良好，專注力才好',
        content: '四件基礎事：\n① 充足睡眠：0-3月14hr、1-2歲11hr、3-5歲10hr、6-13歲9hr\n② 積極運動：每天至少60分鐘身體活動\n③ 健康飲食：避免過多化學添加物\n④ 控制疾病：過敏、慢性鼻炎、睡眠問題都影響專注力',
      },
      {
        title: '建立自信心，產生內在動機',
        content: '破除習得無助感四步驟：\n① 建立歸屬感（孩子感受到被接受和被愛）\n② 任務由淺入深（先讓他有成功經驗）\n③ 建立自信心（稱讚努力和過程）\n④ 產生內在動機（因為有趣，而不是為了獎勵）',
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: '蒙特梭利 vs 華德福',
        content: '兩種都是全人教育，各有特色：\n\n🔵 蒙特梭利：混齡班、精心設計的教具環境、手的操作、培養獨立思考\n🟢 華德福：分齡、老師即課本、藝術核心、良善純美與自然連結\n\n💡 選擇前多去參觀，看孩子喜不喜歡那個氛圍！',
      },
    ],
  },
]
