...
const PSYCH_HUANG_TOPICS = [
  ...
  },
  {
    ...
    sections: [
      {
        title: 'CH1-1 情緒教育的起點：從理解到對頻的三個關鍵',
        content: '你已經很努力了！情緒教育不是天生就會的，是需要練習的技能。\n\n三個幫你「對頻」孩子的關鍵：\n① 回到童年：試著想想自己小時候的感受，就能更理解孩子為什麼這麼在意一件「小事」\n② 聽懂孩子的語言：孩子的行為就是他的語言——哭、鬧、發脾氣，都是在告訴你某件事\n③ 一對一相處時間：每天哪怕只有10分鐘，拉出專屬於你和孩子的時光，連結就在這裡發生\n\n💛 核心提醒：「我們不知道孩子心裡在想什麼」——所以要學會對頻，像對好朋友說話一樣對孩子說話。\n\n情緒教育需要時間練習才能看到效果，給自己和孩子都多一點耐心。',
      },
      {
      ...
      },
      {
        ...
        content: '很多爸媽都有過「忍不住就打下去」的時刻，這不代表你是壞父母——這代表你需要更多的工具。\n\n處罰和教養的差別：\n• 處罰：讓孩子感到痛苦或恐懼，從而停止行為（短期有效，長期傷害關係與自信）\n• 教養：幫助孩子理解為什麼、學會更好的選擇（需要時間，但效果持久）\n\n打罵的代價：\n• 孩子學到的是「強者可以用力量控制弱者」\n• 傷害的是你們之間最珍貴的信任和連結\n• 孩子表面服從，內心可能是恐懼而非真正理解\n\n💛 你已經在學習更好的方式了，這就是最好的開始。',
      },
      {
        title: 'CH2-2 不發脾氣也能教！溫和設定界線與規範',
        content: '溫和不等於沒有界線！孩子需要的是「溫柔而一致」的爸媽，而不是有時鬆有時嚴。\n\n溫和設定界線的原則：\n• 事先說清楚規則（不要等到孩子做錯才宣布）\n• 語氣溫和，但執行一致（說到做到，不因孩子哭鬧就讓步）\n• 界線針對「行為」，不針對「孩子這個人」\n• 規則背後有原因，適齡地解釋給孩子聽\n\n💡 一個實用做法：每個月挑一個「最讓你頭痛的行為」設定主題，溫柔但清楚地一起練習，而不是同時改所有事。\n\n記住：一致性比完美更重要，孩子需要的是可預測的界線，不是完美的父母。',
      },
      {
        title: 'CH2-3 不小心罵了孩子，可以怎麼補救？',
        content: '爸媽也是人，偶爾失控不等於失格——重要的是你願意修復。\n\n失控後的補救步驟：\n① 先讓自己冷靜（不要在還在火頭上時道歉，那樣沒有意義）\n② 主動找孩子，蹲下來平視\n③ 誠實道歉：「剛才媽媽/爸爸太大聲了，這樣讓你害怕，對不起」\n④ 解釋你的感受（不是藉口，而是讓孩子理解大人也有情緒）\n⑤ 一起討論下次可以怎麼做\n\n💛 這個修復過程本身就是很好的情緒教育——孩子看到：犯錯了可以道歉，關係是可以修復的。\n\n你的勇氣和真誠，孩子都感受得到。',
      },
      {
