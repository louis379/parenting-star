...
const MOCK_PLACES = [
  ...
  { id: '2', name: '國立自然科學博物館', city: '台中市', district: '北區', is_indoor: true, types: ['science', 'nature'], suitable_age_min: 24, suitable_age_max: 144, avg_rating: 4.7, review_count: 512, avg_stay_minutes: 240, features: ['恐龍化石', '3D劇場', '太空劇場', '植物園'], budget: 'low', transport: 'bus', description: '台灣最完整的自然科學博物館，科教設施豐富。' },
  { id: '3', name: '飛牛牧場', city: '苗栗縣', district: '通霄鎮', is_indoor: false, types: ['nature', 'craft'], suitable_age_min: 12, suitable_age_max: 144, avg_rating: 4.3, review_count: 187, avg_stay_minutes: 300, features: ['餵牛體驗', '擠牛奶', '牧場導覽', '牛奶冰淇淋'], budget: 'medium', transport: 'car', description: '親子農場體驗，可接觸各種農場動物，DIY乳製品。' },
  { id: '4', name: '台灣海洋生態館', city: '屏東縣', district: '車城鄉', is_indoor: true, types: ['science', 'nature'], suitable_age_min: 12, suitable_age_max: 144, avg_rating: 4.8, review_count: 645, avg_stay_minutes: 360, features: ['鯊魚館', '珊瑚王國', '鯨鯊展示', '沙灘區'], budget: 'medium', transport: 'car', description: '台灣最大水族館，海洋生態教育豐富。' },
  ...
  { id: '6', name: '林口亞典藝術館', city: '新北市', district: '林口區', is_indoor: true, types: ['art', 'craft'], suitable_age_min: 36, suitable_age_max: 144, avg_rating: 4.2, review_count: 98, avg_stay_minutes: 150, features: ['陶藝DIY', '彩繪體驗', '親子畫室', '藝術裝置'], budget: 'medium', transport: 'car', description: '以藝術創作為主題的親子館，各年齡層都有適合的課程。' },
]
